...
//Paginacacao
$SQLPag = "SELECT id FROM suporte WHERE UserReceptor = :UserReceptor AND PastaReceptor = :PastaReceptor".$SelectLido." OR UserEmissor = :UserEmissor AND LidaEmissor = :LidaEmissor ORDER BY id DESC";
...
$SQLPag->bindParam(':LidaEmissor', $VerLidaEmissor, PDO::PARAM_STR);
...
//Seleção
$SQL = "SELECT * FROM suporte WHERE UserReceptor = :UserReceptor AND PastaReceptor = :PastaReceptor".$SelectLido." OR UserEmissor = :UserEmissor AND LidaEmissor = :LidaEmissor ORDER BY id DESC LIMIT :LimitComecar, :LimitQuant";
...
$SQL->bindParam(':LidaEmissor', $VerLidaEmissor, PDO::PARAM_STR);
...
<div class="content-frame-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body mail">
								...
								if($Ln['UserEmissor'] == $CadUser){
									$mailunread = $Ln['LidaEmissor'] == "N" ? " mail-unread" : "";
								}else{
									$mailunread = $Ln['LidaReceptor'] == "N" ? " mail-unread" : "";
								}
