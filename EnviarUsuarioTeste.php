<?php
	...
	if(empty($SQLU)){
		echo MensagemAlerta('Erro', 'Ocorreu um erro ao tornar o teste em usuário.', "danger");
	}
	else{
		echo MensagemAlerta('Sucesso', 'Teste convertido a usuário com sucesso!', "success", "index.php?p=criar-teste");
	}
