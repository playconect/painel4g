<?php
	...
	if(empty($SQL)){
		...
		echo "<a class=\"desbloquear label label-success\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Desbloquear\" Onclick=\"DesbloquearUser('".$id."', 'StatusBloDes".$id."')\"><i class=\"fa fa-unlock-alt\"></i></a>";
	}
