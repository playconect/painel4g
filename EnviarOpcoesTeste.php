<?php
	...
	if(empty($SQL)){
		echo MensagemAlerta('Erro', 'Ocorreu um erro, por favor, procure o administrador!', "danger", "index.php?p=criar-teste");
	}
	else{
		echo MensagemAlerta('Sucesso', 'Realizado com sucesso', "success", "index.php?p=criar-teste");
	}
