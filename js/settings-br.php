...
var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> Fixar Cabeçalho</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1"/> Fixar Barra Lateral</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> Rolagem Barra Lateral</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> Barra Lateral na Direita</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> Navegação Personalizada</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> Alternar Navegação</label>'
        +'</div>'
        +'<div class="ts-title">Leiaute</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0"/> Completo</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> Centralizado</label>'
        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Papel de Parede</div>'
            +'<div class="ts-themes">'
...
/*
	...
	?>	
		...
		$(".x-navigation .xn-logo .TituloPainel").attr('titulo', 'S');
		$(".x-navigation .xn-logo .TituloPainel").html("<?php echo $VerificarInfoSite[0][0]; ?>");
	<?php
	}
	?>
	...
	$(".x-navigation-minimize").click(function(){
		...
		var titulo = $(".x-navigation .xn-logo .TituloPainel").attr("titulo"); 
		
		if(titulo == "S"){
			$(".x-navigation .xn-logo .TituloPainel").html("<?php echo $VerificarInfoSite[0]; ?>");
			$(".x-navigation .xn-logo .TituloPainel").attr('titulo', 'N');
		}
		else{
			$(".x-navigation .xn-logo .TituloPainel").html("<?php echo $VerificarInfoSite[0][0]; ?>");
			$(".x-navigation .xn-logo .TituloPainel").attr('titulo', 'S');
