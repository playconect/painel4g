...
var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
        +'<div class="ts-title">Opzioni</div>'
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> Intestazione Fisso</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> Barra Laterale Fissa</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> Scroll Barra Laterale</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> Barra Laterale Destra</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> Navigazione Personalizzata</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> Toggle Navigazione</label>'
        +'</div>'
        +'<div class="ts-title">Disposizione</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0"/> Pieno</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> Centrato</label>'
        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Sfondi</div>'
            +'<div class="ts-themes">'
