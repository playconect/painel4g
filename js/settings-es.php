...
var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
        +'<div class="ts-title">Opciones</div>'
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/> Cabecera Fijo</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check <?php echo $LeiauteDesabled; ?>"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> Barra Lateral Fijo</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> Barra Lateral la Voluta</label>'
        +'</div>'
        +'<div class="ts-row">'
        ...
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> Navegación de Palanca</label>'
        +'</div>'
        ...
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> Centrado</label>'
        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Fondos de Pantalla</div>'
            +'<div class="ts-themes">'
