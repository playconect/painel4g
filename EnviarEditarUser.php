...
$TotalResul = count($SQLUser->fetchAll());
	...
	if(empty($SQL)){
		echo MensagemAlerta('Erro', 'Ocorreu um problema ao editar o usuário!', "danger", "index.php?p=usuario");
	}
	else{
		echo MensagemAlerta('Sucesso', 'Usuário editado com sucesso!', "success", "index.php?p=usuario");
	}
